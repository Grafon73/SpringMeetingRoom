...
@ComponentScans(value = { @ComponentScan("com.test.application.repos"),
        @ComponentScan("com.test.application.service") })
public class HibernateConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("com.test.application.model");
